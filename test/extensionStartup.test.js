...
test('real E2E bootstraps an outdated protocol-5 tab, reloads it, and selects the compatible reconnect', async () => {
  ...
  const api = async (_options, route, request = {}) => {
      ...
      return {
        clients: [reloaded
          ? {
              ...
              extensionVersion: BUNDLED_EXTENSION.version, extensionBundleId: BUNDLED_EXTENSION.bundleId, clientVersion: BUNDLED_EXTENSION.contentVersion, extensionProtocolVersion: 5,
    ...
    if (route === '/browser/extension/reload') {
      ...
      assert.equal(request.body.allowMaintenancePageBootstrap, true);
      return { reconnected: { id: 'updated-tab', extensionVersion: BUNDLED_EXTENSION.version, extensionBundleId: BUNDLED_EXTENSION.bundleId, clientVersion: BUNDLED_EXTENSION.contentVersion, backgroundEpoch: 'background-new', contentEpoch: 'content-new' } };
    }
